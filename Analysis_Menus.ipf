...
Window Main_panel() : Panel
    ...
    TabControl tb, tabLabel(3)="Export", value=0

    // --- Tab 0: Organize ---
    Button btnorder,    pos={24,45},  size={100,20}, proc=LogButtonProc, title="Organize data", disable=0

    // --- Tabs 1 and 2: shared ---
    Button btnStim,     pos={24,45},  size={100,20}, proc=LogButtonProc, title="Plot Exp",      disable=1
    ...
    // --- Tab 2: IV (disabled — under development) ---
    ...
    // --- Tab 3: Export ---
    Button btnExportNM, pos={24,45},  size={120,20}, proc=LogButtonProc, title="Export to NM",  disable=1
EndMacro
...
Function TabProc(tca) : TabControl
    ...
    Variable tabNum, isTab0, isTab1, isTab3
    ...
    switch (tca.eventCode)
        case 2:
            ...
            // Tab 1: Ramp only (btnStim shared with Ramp)
            ModifyControl btnStim     disable = !isTab1
            ModifyControl btnRamp     disable = !isTab1
            ModifyControl btnplotamp  disable = !isTab1

            // Tab 2: IV — disabled (under development)
            ModifyControl btnIV       disable = 1
            ModifyControl btnIVgraph  disable = 1

            // Tab 3: Export only
            ModifyControl btnExportNM disable = !isTab3
            break
    endswitch
